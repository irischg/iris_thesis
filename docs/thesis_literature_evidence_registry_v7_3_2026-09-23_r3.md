# Thesis Literature Evidence Registry v7.3 R3
...
**Compiled:** 2026-08-04  
**Updated:** 2026-09-23 (R3) — Registry v7.3 **R3** is the minimal additive successor candidate to the failed R2 candidate (`460c30fefb70d64d614d02039205dde0fbe2e45c20462a9f19c256f392716b0c`), which did not pass independent acceptance because it inherited an unscoped statement assigning current methodology authority to Framework v7.2. R3 corrects only that temporal/current-authority ambiguity and the dependent lifecycle, status, and audit statements; it preserves R2's P1-E correction, project evidence, numerical corrections, and all scientific/evidence content unchanged. See **§18** for the historical R1→R2 record and **§19** for the R2→R3 correction record. R3 remains an additive candidate aligning the evidence base with accepted Research Framework v7.3's reconstructed-PV mainline successor decision. The separately validated, weather-informed reconstructed full-year PV (including the prolonged 2024/11–12 unavailable block) remains the best-estimate planning mainline, and the prior zero-winter-PV treatment remains a conservative stress/sensitivity. A1–A4, B1–B2, Gate 1, and Gate 2 remain methodologically closed and are not reopened.

**Version lineage:** Registry v7.3 R3 is the direct, additive successor to the immutable failed R2 candidate `thesis_literature_evidence_registry_v7_3_2026-09-23_r2.md`, which itself succeeded the immutable failed R1 candidate `thesis_literature_evidence_registry_v7_3_2026-09-23.md` and the accepted historical Registry v7.2 predecessor. R3 aligns to accepted `research_framework_v7_3_2026-09-23.md`. It does not reopen the v7.1/v7.2 preprocessing, resilience, billing, degradation, or Layer A/B/DG method decisions. The substantive v7.3 change remains limited to the reconstructed-PV mainline/sensitivity role reversal and its supporting project evidence; all v7.2 literature roles, project evidence, claim-to-source rows, and claim boundaries not explicitly updated below remain unchanged. Registry v7.3 R3 is a **candidate only** — it is not self-accepting and does not become the evidence source of truth until independently audited and accepted, per `docs/protocols/Iris_Thesis_Version_Provenance_Management_Protocol_v1_2026-09-21.md`.
...
> | `thesis_literature_evidence_registry_v7_3_2026-09-23.md` | **Failed R1 candidate — immutable provenance**; did not pass independent acceptance (unscoped P1-E wording + inaccurate self-audit certification). Retained byte-identical. | `e06f5a1e30ffd7af0c3a8405e6758c25f82d18eb7756bb05da276dffe609db1e` |
> | `docs/checkpoints/literature_evidence_registry_v7_3_reconstructed_pv_alignment_candidate_2026-09-23.md` | Failed R1 checkpoint — immutable provenance; its `D = 0` certification is withdrawn | `301b931a3b7ea4b0c981079789e66a69e5571294a0d29467bd0c6c262c17fe2d` |
> | `thesis_literature_evidence_registry_v7_3_2026-09-23_r2.md` | **Failed R2 candidate — immutable provenance**; did not pass independent acceptance because of an inherited unscoped current-authority statement | `460c30fefb70d64d614d02039205dde0fbe2e45c20462a9f19c256f392716b0c` |
> | `docs/checkpoints/literature_evidence_registry_v7_3_reconstructed_pv_alignment_candidate_r2_2026-09-23.md` | Failed R2 checkpoint — immutable provenance; its `D = 0` / no-contradiction conclusions are withdrawn | `5b9f063709b680f8099d72ee440d9be6be02687e82476267903f95be8f416917` |
> | `thesis_literature_evidence_registry_v7_3_2026-09-23_r3.md` | Minimal additive successor candidate (this file) | `SELF-HASH: recorded in the R3 candidate checkpoint after generation` |
>
> **Supersession rule:** this v7.3 R3 file is a candidate and is not self-accepting. It succeeds the failed R1 and R2 candidates, both retained unedited as immutable provenance and neither citable as current. Framework v7.3 is the accepted methodology source of truth. Registry v7.2 remains the last accepted evidence source of truth until an independent audit accepts this R3 successor. Once accepted, v7.3 supersedes v7.2 only where this document explicitly changes the reconstructed-PV evidence role; every v7.1/v7.2 evidence role, claim-to-source row, and claim boundary not explicitly updated below is preserved. v7.1's preliminary-optimized-\(P^B\)-dependent cost-bracket rule remains superseded exactly as in v7.2.
...
**Coding source-of-truth rule:** Under the v7.2 authority state, Framework v7.2 and Registry v7.2 were the then-current mainline specification/evidence pair. Under the current v7.3 transition state, Framework v7.3 is the accepted methodology source of truth; Registry v7.2 remains the last accepted evidence source of truth until a v7.3 Registry successor passes independent acceptance. Registry v7.3 R3 is a candidate only. Framework v7.2 is a historical methodology predecessor, not current methodology authority. Earlier framework/registry versions may be used only when the current accepted Framework or Registry explicitly classifies them as legacy, replication, regression, provenance, historical lineage, or comparison material. Current accepted machine-readable artifacts, not historical framework constants, control exact production values.
...
| Registry v7.3 R2 (failed candidate) | **SUPERSEDED** -- failed independent acceptance on inherited current-authority wording; immutable provenance |
| Registry v7.3 R3 (this file) | **`CANDIDATE PASS`** -- not yet independently accepted |
...
source of truth. Registry v7.2 remains the last accepted evidence source of truth pending independent
acceptance of a v7.3 Registry successor.
...
R3 replaces only that ambiguous current-authority rule with explicit temporal separation:

- under the v7.2 authority state, Framework v7.2 and Registry v7.2 were the then-current pair;
- under the current v7.3 transition state, Framework v7.3 is the accepted methodology source of truth;
...
R3 is a **candidate only**. It is not self-accepting and does not become the evidence source of truth
until an independent, read-only audit accepts it. Registry v7.2 remains the last accepted evidence source
of truth until then. No canonical artifact was created, no production routing was changed, and no solve
was performed.
