# Thesis Literature Evidence Registry v7.3 R2
...
**Compiled:** 2026-08-04  
**Updated:** 2026-09-23 (R2) — Registry v7.3 **R2** is the additive successor candidate to the failed R1 candidate (`e06f5a1e30ffd7af0c3a8405e6758c25f82d18eb7756bb05da276dffe609db1e`), which did not pass independent acceptance. R2 corrects the R1 defects identified by that audit — unscoped present-tense P1-E wording that read as a current prescription of the superseded zero-winter mainline, and an inaccurate self-audit certification — without altering any accepted methodology. See **§18** for the full R1→R2 lifecycle record. Like R1, R2 is an additive candidate aligning the evidence base with accepted Research Framework v7.3's reconstructed-PV mainline successor decision. It preserves the entire Registry v7.2 evidence base, claim-to-source map, and claim boundaries, and adds the project evidence (Steps 17a / corrected 17b / 17c) and role realignment required by the single Framework v7.3 methodology change: the separately validated, weather-informed reconstructed full-year PV (including the prolonged 2024/11–12 unavailable block) is promoted to the best-estimate planning mainline, and the prior zero-winter-PV treatment is reclassified as a conservative stress/sensitivity. A1–A4, B1–B2, Gate 1, and Gate 2 remain methodologically closed and are not reopened.

**Version lineage:** Registry v7.3 R2 is the direct, additive successor to `thesis_literature_evidence_registry_v7_2_2026-08-24.md`, and the corrective successor to the immutable failed R1 candidate `thesis_literature_evidence_registry_v7_3_2026-09-23.md` and aligns to accepted `research_framework_v7_3_2026-09-23.md`. It does not reopen the v7.1/v7.2 preprocessing, resilience, billing, degradation, or Layer A/B/DG method decisions. The substantive v7.3 change is limited to the reconstructed-PV mainline/sensitivity role reversal and its supporting project evidence; all v7.2 literature roles, project evidence, claim-to-source rows, and claim boundaries not explicitly updated below remain unchanged. Registry v7.3 is a **candidate only** — it is not self-accepting and does not become the evidence source of truth until independently audited and accepted, per `docs/protocols/Iris_Thesis_Version_Provenance_Management_Protocol_v1_2026-09-21.md`.

> **Source manifest / provenance**
>
> | Source artifact | Role in v7.3 candidate | SHA-256 |
> |---|---|---|
> | `thesis_literature_evidence_registry_v7_2_2026-08-24.md` | Immediate predecessor; remains authoritative evidence source of truth until this candidate is independently accepted | `8b72bd3f56226f0be6900f52779b1702daaa8bbf85f674040b336f9aae6e021e` |
> | `research_framework_v7_3_2026-09-23.md` | Accepted framework alignment target (independently audited CLOSED / ACCEPTED) | `44e313e71ea2a01e213454b4d838a86ec674fcda4f95a3b194ed68a92115ef2a` |
...
> | `data/processed/alternatives/annual_input_v7_2_winter_pv_sensitivity_protocol_2026-09-07.parquet` | Original Step 17b sensitivity-only artifact (historical; not promotion source) | `023cba88416b965c7dedf4139e9a495602039117ecc827e52a372f10a1aad986` |
> | `data/processed/alternatives/annual_input_v7_2_winter_pv_sensitivity_corrected_authority_project_venv_2026-09-18.parquet` | Corrected Step 17b reconstructed-PV promotion-source candidate; not canonical | `1c1dbc265b092415e649bba23232f645f7ba5c74e0f074f2914c1ed7ac9d7cd9` |
> | `results/sensitivity/winter_pv_17c/20260918T155044175327Z_3d71b70173/paired_sensitivity_comparison.json` | Step 17c paired reconstructed-vs-zero-winter sensitivity/adjudication evidence | `b8acd3027c3c1db31bd8840cf0ea6af7f67ea784fcd856bb3dcd2e3317677ca5` |
> | `thesis_literature_evidence_registry_v7_3_2026-09-23.md` | **Failed R1 candidate — immutable provenance**; did not pass independent acceptance (unscoped P1-E wording + inaccurate self-audit certification). Retained byte-identical; superseded by this R2. | `e06f5a1e30ffd7af0c3a8405e6758c25f82d18eb7756bb05da276dffe609db1e` |
> | `docs/checkpoints/literature_evidence_registry_v7_3_reconstructed_pv_alignment_candidate_2026-09-23.md` | Failed R1 checkpoint — immutable provenance; its `D = 0` certification is superseded by this R2's re-derivation | `301b931a3b7ea4b0c981079789e66a69e5571294a0d29467bd0c6c262c17fe2d` |
> | `thesis_literature_evidence_registry_v7_3_2026-09-23_r2.md` | Additive successor candidate (this file) | `SELF-HASH: recorded in the R2 candidate checkpoint after generation` |
>
> **Supersession rule:** this v7.3 R2 file is a candidate and is not self-accepting. It supersedes the failed R1 candidate, which is retained unedited as immutable provenance and must not be cited as current. Registry v7.2 remains the current accepted evidence source of truth until an independent audit accepts this successor. Once accepted, v7.3 supersedes v7.2 only where this document explicitly changes the reconstructed-PV evidence role; every v7.1/v7.2 evidence role, claim-to-source row, and claim boundary not explicitly updated below is preserved. v7.1's preliminary-optimized-\(P^B\)-dependent cost-bracket rule remains superseded exactly as in v7.2.
...
> \]
>
> — the separately validated, weather-informed reconstructed planning baseline — and the zero-availability treatment boxed above is retained as the **conservative stress/sensitivity** case. This Registry records both roles with explicit temporal scope; it does not itself decide the methodology. See **[P7]** and **§17**.
...
- winter-PV long-block alternative sensitivity（歷史 v7.2 pending item；後續 Step 17a/17b/17c project evidence見 P7；**v7.3 mainline promotion decision已 CLOSED，但 canonical reconstructed-mainline artifact與 production routing仍 NOT_YET_AUTHORIZED -- 見 §17**）。
...
**Interpretation and consequence.** These fields accurately describe *how this artifact was constructed* (a v7.2 sensitivity branch) and inaccurately describe *the role v7.3 assigns to its values*. They do not affect the numeric reconstruction, which was independently verified above. Crucially, this is a substantive reason the future canonical reconstructed-mainline artifact must be **newly built** under mainline semantics rather than produced by renaming, re-labelling, or re-pathing this parquet: a rename would leave a file whose own provenance fields assert a sensitivity-branch identity while being routed as production mainline. The artifact must not be mutated in place to resolve this; it is immutable evidence of the sensitivity-branch run.

**Role:** corrected, separately validated **promotion-source candidate**; **not canonical**. No forbidden canonical-column mutation was found (observed columns unchanged; reconstruction confined to the planning-baseline `pv_available_*` columns with explicit status/method flags). The future canonical reconstructed-mainline artifact's path/hash remain `NOT_YET_CREATED / NOT_YET_AUTHORIZED`; this candidate must not be renamed or treated as that artifact.
...
| Item | Role | Not authorized to claim |
|---|---|---|
| Step 17a | `PASS_FOR_SENSITIVITY`; separate long-block/monthly holdout validation evidence | observed truth, exact recovery, standalone completion of canonical promotion |
| Original Step 17b | sensitivity-only historical run/evidence | v7.3 canonical mainline |
| Corrected Step 17b | corrected promotion-source candidate | canonical artifact or production authorization |
| Step 17c | paired reconstructed-vs-zero-winter sensitivity and adjudication evidence | accepted v7.3 EOB/final production rerun; full-81-point robustness |

**Evidence role:** project evidence basis for the Framework v7.3 reconstructed-PV mainline/sensitivity role reversal; promotion/adjudication candidate evidence, **not** production acceptance evidence.
...
| v7.3 mainline reconstructed full-year PV (incl. 1,463-hour prolonged block) | **P7 (17a + corrected 17b + 17c) + accepted Framework v7.3 decision** | model-based, weather-informed, separately validated best-estimate planning baseline; not observed truth or exact recovery; same artifact must feed EOB/economic, Layer A \(R\)/\(P^{out}\)/binding/outage replay, and baseline Layer B |
| prior zero-winter annual treatment (conservative stress/sensitivity) | **P1 + Framework v7.2 historical mainline role, retained as v7.3 sensitivity** | 1,463 h以zero availability處理作為 conservative stress boundary；short-gap validation本身不能外推成long-block reconstruction -- that extrapolation gap is why P7/17a's separate holdout validation was required |
...
- "Under accepted Framework v7.3, the 1,463-hour prolonged winter PV block is represented using a **separately validated, weather-informed reconstruction** (Step 17a long-block holdout validation; corrected Step 17b/17c evidence) as the **best-estimate planning mainline**; the prior zero-winter treatment is retained as a **conservative stress/sensitivity** case."
...
- "The corrected Step 17b artifact is the canonical reconstructed-mainline production input." (it is a promotion-source candidate only; the canonical artifact is `NOT_YET_CREATED / NOT_YET_AUTHORIZED`)
...
- **Blocker 2 / preprocessing empirical freeze**：P1 已以 Scripts 02–05 更新。Load production = same weekday ±6 weeks/K=1；PV donor ±30d/K5 mean = benchmark；PV short-gap production = CWA `hourly_ghi_ratio_median`；10 Load + 10 PV outage hours已重建；1,463 h long unavailable PV under **historical v7.2 mainline** treatment used zero availability。**Under accepted Framework v7.3（見 P7）**，同一 1,463-hour block改用 separately validated reconstructed PV作 best-estimate planning mainline，先前 zero-availability treatment改列 conservative stress/sensitivity；這是 evidence-role update，不是 Scripts 02–05 re-audit。
...
- **v7.3 reconstructed-PV mainline promotion**：P7（Step 17a `PASS_FOR_SENSITIVITY` + corrected Step 17b promotion-source candidate + Step 17c paired evidence）+ accepted Framework v7.3 §35 decision。Registry v7.3 candidate自身仍為 `NOT_YET_ACCEPTED`；future canonical reconstructed-mainline artifact為 `NOT_YET_CREATED / NOT_YET_AUTHORIZED`；production routing為 `NOT_YET_AUTHORIZED`。
...
- Do not describe the corrected Step 17b artifact (`...corrected_authority_project_venv_2026-09-18.parquet`) as the canonical reconstructed-mainline production input; it is a promotion-source candidate only (P7-C).
...
# 17. Framework v7.3 reconstructed-PV mainline evidence alignment

本節是 Registry v7.3 candidate 相對於 Registry v7.2 的 additive evidence-role delta 與 current-state 對照，對應 accepted Framework v7.3 §35 的 methodology decision。它只改變 prolonged-winter PV 的 evidence role assignment，不建立新文獻主張，也不重新打開 A1-A4 / B1-B2 / Gate 1-2。

## 17.1 Decision and epistemic boundary (evidence-role restatement)

**Methodology decision (owned by Framework v7.3, restated here for evidence traceability):** reconstructed full-year PV (含 2024/11-12 共 1,463 個 unavailable-observation hours) 是 v7.3 的 mainline best-estimate planning baseline; v7.2 的 zero-winter treatment 改列 conservative stress/sensitivity. This decision is Framework authority (Category C below); Registry v7.3 supplies the supporting project evidence (P7) and the literature/claim boundary, and does not itself decide methodology.
...
**R2 coverage result.** Fourteen acceptance-relevant Framework v7.3 reconstructed-PV claims were identified from a fresh full read of the accepted Framework's primary bytes and are mapped above and in Sec 17.9: (1) reconstructed full-year PV = mainline; (2) zero-winter = conservative stress/sensitivity; (3) observed vs planning-baseline separation; (4) long-block reconstruction validation requirement; (5) weather-informed reconstruction basis; (6) reconstruction epistemic boundary; (7) same reconstructed artifact for economics and Layer A; (8) \(R(\alpha,\beta)\)/\(P^{out}\)/binding-window semantics; (9) Layer A outage replay semantics; (10) baseline Layer B semantics; (11) billing calibration remains observed-data based; (12) sensitivity-role reversal; (13) limitation / claim boundary; (14) current implementation authorization state. No unmapped acceptance-relevant claim was found, and — unlike R1 — no mapped claim is contradicted elsewhere in this Registry; see Sec 17.9 for the contradiction sweep that now explicitly covers P1-E.
...
## 17.5 Mainline / zero-winter role alignment table

| Role | v7.2 (historical) | v7.3 candidate (current) |
|---|---|---|
| Reconstructed full-year PV (incl. 1,463 h block) | sensitivity branch only; not mainline | **mainline best-estimate planning baseline** |
| Zero-winter annual treatment | mainline | **conservative stress/sensitivity** |
| Evidence basis for the block | P1 (short-gap only; long-block unvalidated) | P1 (unchanged) + P7 (Step 17a/corrected 17b/17c) |
| Framework authority | Framework v7.2 Sec 4.1.3 (historical) | Framework v7.3 Sec 4.1.3 / Sec 35 (accepted) |
...
## 17.7 Current status boundary

| Layer | State |
|---|---|
| Framework v7.3 | `CLOSED / ACCEPTED` (independently audited) |
| Registry v7.3 R1 (failed candidate) | **SUPERSEDED** -- failed independent acceptance; immutable provenance |
| Registry v7.3 R2 (this file) | **`CANDIDATE PASS`** -- not yet independently accepted |
...
## 17.9 Cross-document consistency audit (against accepted Framework v7.3 primary bytes)

| Item | Framework v7.3 | Registry v7.3 candidate | Consistent? |
|---|---|---|---|
...
| Zero-winter role | conservative stress/sensitivity | conservative stress/sensitivity (Sec 12, Sec 14, P7) | YES |
...
| Future canonical-input status | `NOT_YET_CREATED / NOT_YET_AUTHORIZED` | same (Sec 15, Sec 17.7) | YES |
| Final81 status | not authorized under v7.3 | same (Sec 17.7) | YES |

**Sweep scope (corrected for R2).** Unlike R1, this sweep is not limited to Sec 12 / Sec 14 / P7. It was run over the whole Registry, and specifically over every location that states a `PV_t^{base}` assignment, a mainline/sensitivity role, or a zero-availability treatment for the 1,463-hour block — including [P1]/P1-E, which R1's equivalent sweep omitted and which was the sole cause of R1's failure. No Framework/Registry contradiction was found in R2.

## 17.10 Stale-wording audit disposition

A complete, independently re-derived stale-wording inventory of **this R2 document** is recorded in the accompanying R2 checkpoint (`docs/checkpoints/literature_evidence_registry_v7_3_reconstructed_pv_alignment_candidate_r2_2026-09-23.md`), not duplicated here to avoid a second, potentially drifting count. Acceptance target: zero Category-D (stale/contradictory/ambiguous) occurrences.

The R1 checkpoint's `D = 0` certification is **withdrawn and superseded**: it rested on a misdescription of R1's own bytes (it cited the boxed equation at the wrong line, asserted that a forward reference immediately followed it when two paragraphs intervened, and treated that forward reference as scoping the equation when the reference's own text said it "does not alter" the finding and that the finding "remains true under Framework v7.3"). The R2 count is re-derived from R2 bytes and its derivation, including the exact locations that previously carried Category D, is recorded in the R2 checkpoint.

## 17.11 Candidate disposition

本 Registry successor 的文件內狀態為：

> **LITERATURE / EVIDENCE REGISTRY V7.3 R2 RECONSTRUCTED-PV MAINLINE ALIGNMENT -- CANDIDATE PASS**

This disposition means the document is internally complete and consistent with accepted Framework v7.3; it does **not** mean Registry acceptance, canonical-artifact promotion, routing authorization, or production-run authorization. An independent audit of this candidate is required before it becomes the evidence source of truth.
...
| `docs/thesis_literature_evidence_registry_v7_3_2026-09-23_r2.md` | recorded in the R2 checkpoint | **R2 successor candidate (this file) — CANDIDATE only, not accepted** |
...
R2 is a **candidate**. It is not self-accepting and does not become the evidence source of truth until
an independent, read-only audit accepts it. Registry v7.2 remains the accepted evidence source of truth
until then.
